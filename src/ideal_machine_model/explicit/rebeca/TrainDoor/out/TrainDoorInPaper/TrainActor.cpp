        ...
        switch (messageQueue[cnt]) {
	                    case STOP: {
                        	...
                        	boolean _ref_tmove;
                        	            			            	                                            ...
                        	            			            	                                            _ref_tmove = (bool) (paramQueue[cnt] [i] & AbstractActor::coeff[0]);
++i;
                    out << "stop("
                                	<< (_ref_tmove? "true" : "false")
                	                                << ")";
                break;
               }
	                    case MOVE: {
                    ...
                    case STOP:
                {
                    int i = 0;
                        	...
                        	boolean _ref_tmove;
                        	            			            	                                            ...
                        	            			            	                                            _ref_tmove = (bool) (paramQueue[0] [i] & AbstractActor::coeff[0]);
++i;
                        return msgsrvstop(
                            	                        _ref_tmove
	                                        );
...
paramsValues [index] |= (_ref_tmove ? 0xFF : 0x00) & AbstractActor::coeff[0]; 
++index;
